...
const companies = [
  {
    ...
    description: "Social commerce platform democratizing internet access for small businesses.",
    growth: "+42% YoY",
    hq: "Bengaluru, India",
    stage: "Series F",
  },
  {
    ...
    slug: "flipkart",
    industry: "Marketplace",
    description: "India's homegrown e-commerce giant powering millions of daily transactions.",
    growth: "+18% YoY",
    hq: "Bengaluru, India",
    stage: "Acquired",
  },
  {
    ...
    description: "10-minute grocery delivery redefining instant commerce in urban India.",
    growth: "+65% YoY",
    hq: "Gurugram, India",
    stage: "Public",
  },
  {
    ...
    slug: "zepto",
    industry: "Quick Commerce",
    description: "Dark-store led quick commerce network built for hyper-fast delivery.",
    growth: "+120% YoY",
    hq: "Mumbai, India",
    stage: "Series F",
  },
  {
    ...
    slug: "swiggy",
    industry: "Quick Commerce",
    description: "Food and grocery delivery super-app serving hundreds of Indian cities.",
    growth: "+22% YoY",
    hq: "Bengaluru, India",
    stage: "Public",
  },
  {
    ...
    slug: "phonepe",
    industry: "Fintech",
    description: "UPI-first digital payments platform powering India's cashless economy.",
    growth: "+35% YoY",
    hq: "Bengaluru, India",
    stage: "Series E",
  },
  {
    ...
    slug: "nykaa",
    industry: "Marketplace",
    description: "Beauty and lifestyle commerce platform blending content with retail.",
    growth: "+15% YoY",
    hq: "Mumbai, India",
    stage: "Public",
  },
  {
    ...
    slug: "makemytrip",
    industry: "Travel",
    description: "Full-stack online travel platform for flights, hotels, and holidays.",
    growth: "+27% YoY",
    hq: "Gurugram, India",
    stage: "Public",
  },
